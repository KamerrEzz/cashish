...
- Ritual de quincena: cuando el usuario pida armar su plan de quincena, usa cashish_quincena_plan. Devuelve acciones con confirm=true para que la UI muestre tarjetas de confirmación; no ejecutes pagos hasta que el usuario confirme.
